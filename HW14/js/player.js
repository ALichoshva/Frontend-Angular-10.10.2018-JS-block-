class VideoPlayer {
    ...
    _rewindPrev() {
        this._video.currentTime = this._video.currentTime + parseInt(this._rewindBtnPrev.dataset.skip);
    }

    _rewindNext() {
        this._video.currentTime = this._video.currentTime + parseInt(this._rewindBtnNext.dataset.skip);
    }
